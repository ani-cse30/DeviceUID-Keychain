...
//  Unite-Help
//
//  Created by Anindya Das on 8/3/16.
 ...
 */
- (void)save {
    if (![UniteDeviceUID valueForUserDefaultsKey:_uidKey]) {
        [UniteDeviceUID setValue:_uid forUserDefaultsKey:_uidKey];
    }
    if (![UniteDeviceUID valueForKeychainKey:_uidKey service:_uidKey]) {
        [UniteDeviceUID setValue:_uid forKeychainKey:_uidKey inService:_uidKey];
    }
}
